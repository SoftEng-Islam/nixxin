 ...
 *
 * Disassembly of kernel/firmware/acpi/dsdt.aml
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0000DE26 (56870)
 *     Revision         0x02
 *     Checksum         0x7F
 *     OEM ID           "HPQOEM"
 *     OEM Table ID     "805A    "
...
DefinitionBlock ("", "DSDT", 2, "HPQOEM", "805A    ", 0x00000001)
{
    ...
    Scope (_SB)
    {
        ...
        {
            If (CondRefOf (\_SB.PCI0.VGA.M207))
            {
                Return (^PCI0.VGA.M207) /* External reference */
            }
    ...
    OperationRegion (HPSA, SystemMemory, 0x7EF91000, 0x08)
    ...
    OperationRegion (HPGF, SystemMemory, 0x7EF87000, 0x0210)
    ...
    OperationRegion (HPWM, SystemMemory, 0x7EF8D000, 0x2818)
    ...
    Device (_SB.WMIB)
    {
        ...
        OperationRegion (HWSS, SystemMemory, 0x7EF85000, 0x0802)
    ...
    OperationRegion (HPWV, SystemMemory, 0x7EF8B000, 0x107C)
    ...
    OperationRegion (HPCF, SystemMemory, 0x7EF86000, 0x3A)
    ...
    Name (SS3, One)
    Name (SS4, One)
    OperationRegion (GNVS, SystemMemory, 0x7EF8A000, 0x0147)
    ...
    Scope (_GPE)
    {
        ...
        Method (_E08, 0, NotSerialized)  // _Lxx: Level-Triggered GPE, xx=0x00-0xFF
        {
        }
