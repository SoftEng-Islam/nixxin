{ stdenv, lib, nixosTests, fetchFromGitHub, nodejs, pnpm_10, python3, node-gyp
, cctools, xcbuild, libkrb5, libmongocrypt, libpq, makeWrapper, }:
...
stdenv.mkDerivation (finalAttrs: {
  ...
  meta = {
    ...
    maintainers = with lib.maintainers; [ gepbird AdrienLemaire ];
