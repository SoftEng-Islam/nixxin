...
in {
  home-manager.users.${settings.user.username} = {
    ...
    xdg.configFile.".config/btop/btop.conf".txt = ''
      ...
      theme_background = ${settings.modules.resources_monitoring.btop.background}
      ...
      rounded_corners = ${settings.modules.resources_monitoring.btop.rounded}
      ...
      clock_format = ${settings.modules.resources_monitoring.btop.clock}
      ...
      disks_filter = "exclude=/nix/store /boot/efi /boot /var/lib/docker/btrfs /var/lib/podman/btrfs"
