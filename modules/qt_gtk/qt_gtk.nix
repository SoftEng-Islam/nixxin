...
let
  ...
  kColorSchemeBasic = with config.lib.stylix.colors;
    let
  ...
  kColorScheme-INI = (lib.generators.toINI { } (kColorSchemeBasic // {
    General = {
  ...
  qtct-configFile = version: ''
    ...
    color_scheme_path=${
      if (version == 5) then
        ...
        "/home/julian/.config/qt6ct/colors/StylixDark.colors"
    }
    custom_palette=true
