...
in
{
  home-manager.users.${settings.user.username} = {
    ...
    home.file.".config/noctalia/settings.toml".text = /* toml */ ''
      ...
      builtin_ids                = [ "gtk3", "gtk4", "qt", "hyprland", "wezterm", "btop" ] # opt-in; list ids with: noctalia theme --list-templates
      community_ids              = [ "zed", "yazi", "papirus-icons", "antigravity", "claude-code", "codex", "brave", "discord", "telegram", "blender", "inkscape", "libreoffice", "micro", "obsidian", "vscode", "zed", "steam", "obs", "siyuan", "bat", "fzf", "glow" ]     # fetched from api.noctalia.dev/templates, cached locally
      ...
      # match     = "DP-1"
      # thickness = 44
      # [bar.main.monitor.dp1.dead_zone.actions]
      # left = "panel-toggle launcher"
