    ...
    wayland.windowManager.hyprland = {
      settings.animations = {
        ...
        animation = [
          ...
          "fadeIn, 1, 1.2, almostLinear, popin 95%"
          "fadeOut, 1, 1.0, almostLinear, popin 95%"
          "fade, 1, 1.5, quick, popin 95%"
          "fadeLayersIn, 1, 1.5, almostLinear, popin 95%"
          "fadeLayersOut, 1, 1.2, almostLinear, popin 95%"
