  ...
  home-manager.users.${settings.user.username} = {
    programs.vscode = {
      ...
      profiles.default = {
        ...
        extensions = lib.optionals (settings.modules.development.vscode.extensions_home) nixpkgs-extensions; # ++ market-extensions;
        globalSnippets = mkIf (settings.modules.development.vscode.globalSnippets_home) {
          fixme = {
        ...
        userSettings = mkIf (settings.modules.development.vscode.userSettings_home) {
        ...
        keybindings = lib.optionals (settings.modules.development.vscode.keybindings_home) [
