        ...
        userSettings = {
          ...
          */
          ...
          "nix.serverSettings".nixd = {
            nixpkgs.expr = "(builtins.getFlake \"${inputs.self}\").nixosConfigurations.${config.home.hostname}.pkgs";
            formatting.command = [ "nixfmt" ];
            options = {
              nixos.expr = "(builtins.getFlake \"${inputs.self}\").nixosConfigurations.${config.home.hostname}.options";
