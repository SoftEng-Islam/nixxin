...
url="./vdhcoapp-linux-x86_64.tar.bz2"
...
# curl -L $url > $tmpfile
curl -L --retry 5 --retry-delay 5 --max-time 300 "$url" > "$tmpfile"
...
# Or manually run:
# aria2c https://github.com/aclap-dev/vdhcoapp/releases/latest/download/vdhcoapp-linux-x86_64.tar.bz2
# tar -xf ./vdhcoapp-linux-x86_64.tar.bz2 -C ~/.local/share/
# rm -rf ~/.local/share/vdhcoapp
# mv ~/.local/share/vdhcoapp-{version} ~/.local/share/vdhcoapp
# ~/.local/share/vdhcoapp/vdhcoapp install
